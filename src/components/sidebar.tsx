    ...
    <aside className="w-64 min-h-screen bg-[#FAFAFA] border-r border-gray-200">
      <div className="h-16 flex items-center px-4 border-b border-gray-200">
        <div className="flex items-center">
          <div className="bg-wise-blue text-white w-8 h-8 rounded flex items-center justify-center font-bold text-lg">W</div>
          <span className="text-gray-800 font-medium text-lg ml-2">Wise</span>
        </div>
      </div>
              ...
              <li key={item.key}>
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-md transition-colors
                    ${active ? "bg-wise-light-blue text-wise-blue font-medium" : "text-gray-700 hover:bg-gray-100 hover:text-wise-blue"}`}
